...
#define LOG_INFO(x) SickoLog.Info(_log_source, x)
#define LOG_DEBUG(x) SickoLog.Debug(_log_source, x)
#define LOG_ERROR(x) SickoLog.Error(_log_source, x)
