...
enum ImGuiItemStatusFlags_
{
    ...
    ImGuiItemStatusFlags_ToggledOpen        = 1 << 4,   // Set when TreeNode() reports toggling their open MenuState.
...
struct ImGuiContext
{
    ...
    bool                    ActiveIdHasBeenEditedBefore;        // Was the value associated to the widget Edited over the course of the Active MenuState.
    ...
    ImRect                  NavScoringRect;                     // app::app::app::Rectangle used for scoring, in screen space. Based of window->NavRectRel[], modified for directional navigation scoring.
